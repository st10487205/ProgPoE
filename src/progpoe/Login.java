...
public class Login {
  ...
  //login status
    public String returnLoginStatus(){
      ...
      if(validUsername(getUsername()) == true && validPasswordComplexity(getPassword()) == true){
          loginStatus = ("User registered succcessfully.");  
      }else 
        if(validUsername(getUsername()) == false && validPasswordComplexity(getPassword()) == true) {  
            loginStatus = ("Username is incorrectly formatted.");
       }else
           if(validUsername(getUsername()) == true && validPasswordComplexity(getPassword()) == false){
               loginStatus = ("The password does not meet complexity requirements.");
       }
     return loginStatus;
    }
  ...
  //login user 
    public boolean loginUser(){
        return checkUserName(getUsername()) == true && checkPassword(getPassword()) == true;
    }
}
